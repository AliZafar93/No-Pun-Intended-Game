...
const questions = [
  ...
  "Why did the survey blush?",
  "What did one questionnaire say to the other?",
...
const puns = [
  ...
  "Yes, I moooved it! 🐄🎭😂", // 64
  "Because it saw too many personal questions! 😳📋",
  "Do you think we'll ever find the true answer?" ,
...
function processResponse(response) {
  ...
  if (response.toLowerCase() === correctAnswer) {
    ...
    displayMessage("You are almost right, you got this.", "incoming");
    return;
  } else {
